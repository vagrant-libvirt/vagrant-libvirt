        ...
        def call(env)
          ...
          @@lock.synchronize do
            ...
            env[:box_volumes].each_index do |i|
              ...
              box_image_file = box_image_files[i]
              ...
              message = "Creating volume #{env[:box_volumes][i][:name]}"
              ...
              begin
                fog_volume = env[:machine].provider.driver.connection.volumes.create(
                  ...
                  capacity: "#{env[:box_volumes][i][:virtual_size]}G",
              ...
              ret = upload_image(box_image_file, config.storage_pool_name,
                                env[:box_volumes][i][:name], env) do |progress|
